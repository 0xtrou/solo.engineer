...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteName} — Personal Web Reader`,
    template: `%s | ${siteName}`,
  },
  ...
  category: "technology",
  classification: "Technology, science, business, and public policy",
  openGraph: {
    type: "website",
    url: "/",
    siteName,
    title: `${siteName} — Personal Web Reader`,
    description: siteDescription,
    locale: "en_US",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Signal — Personal Web Reader" }],
  },
  twitter: {
